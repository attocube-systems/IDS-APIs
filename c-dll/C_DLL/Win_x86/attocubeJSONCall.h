...
/** Definitions for the windows DLL interface                                        */
        ...
        #ifdef  DLL_EXPORT
            #define ATTOCUBE_API __declspec(dllexport) __stdcall  /**< For internal use of this header */
        #else
            #define ATTOCUBE_API __declspec(dllimport) __stdcall  /**< For external use of this header */
        #endif
    #else
        #define ATTOCUBE_API    // No definition needed for standalone static library
    #endif
#endif
