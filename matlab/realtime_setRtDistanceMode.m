function [value_errNo] = realtime_setRtDistanceMode(tcp, mode)
% brief : Sets the distance mode.
%
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "sen", "method": "com.attocube.sen.realtime.setRtDistanceMode", "params": [%i], "id": 1, "api": 2}', mode);
