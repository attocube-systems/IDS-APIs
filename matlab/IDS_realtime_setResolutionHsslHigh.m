function [errNo] = IDS_realtime_setResolutionHsslHigh(tcp, value)
...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.ids.realtime.setResolutionHsslHigh", "params": [%i], "id": 1, "api": 2}', value);
