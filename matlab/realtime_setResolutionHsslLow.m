function [value_errNo] = realtime_setResolutionHsslLow(tcp, resolution)
...
data_send = sprintf('{"jsonrpc": "2.0", "pid": "sen", "method": "com.attocube.sen.realtime.setResolutionHsslLow", "params": [%i], "id": 1, "api": 2}', resolution);
