function [errNo] = nlc_estimateNonlinearities(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.sen.nlc.estimateNonlinearities", "params": [%i], "id": 1, "api": 2}', axis);
