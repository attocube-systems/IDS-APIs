function [errNo] = IDS_realtime_setResolutionBissC(tcp, value)
% brief : Sets the BissC resolution.
%
...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.ids.realtime.setResolutionBissC", "params": [%i], "id": 1, "api": 2}', value);
