function [warningNo, contrast, baseline] = IDS_displacement_getAxisSignalQuality(tcp, axis)
...
data_send = sprintf('{"jsonrpc": "2.0", "method": "com.attocube.ids.displacement.getAxisSignalQuality", "params": [%i], "id": 1, "api": 2}', axis);
